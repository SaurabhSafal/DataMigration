...
ON CONFLICT (technical_approval_score_id) DO UPDATE SET
    ...
    public override List<object> GetMappings()
    {
        return new List<object>
        {
            ...
            new { source = "AddedBy", logic = "created_by -> NULL (Fixed Default)", target = "created_by" },
            new { source = "AddedDate", logic = "created_date -> NULL (Fixed Default)", target = "created_date" },
